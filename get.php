...
$city = $_GET['q'];
 $string = "http://api.openweathermap.org/data/2.5/weather?q=".$city."&units=metric&appid=60cfdb775b698374d9487c630f0e4576";
...
<div><a href= "http://localhost/weather/" > BACK TO MAIN PAGE</a></div>
		  </div>
